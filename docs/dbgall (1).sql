...
INSERT INTO `places` VALUES (1,'Выставочный ЗАЛ Национального Художественного Музея','Exhibition','ул. Кирова, 12'),(2,'Национальный худoжественный музей','Exhibition',' ул. Кирова, 9'),(3,'Картинная галерея академика Осипова А.О.','Exhibition','ул. Хабарова, 27'),(4,'Сокровищница Республики Саха (Якутия), музей','Exhibition','ул. Кирова, 12'),(5,'Галерея зарубежного искусства им. М. Ф. Габышева','Exhibition','ул. Петровского, 4'),(6,'Ургэл, арт-галерея','Exhibition','ул. Лермонтова, 35/1'),(7,'Art гараж, художественный салон местных художников','Exhibition','ул. Ойунского, 24/2г'),(8,'Исторический парк \"Россия - моя история\"','Exhibition','улица Ксенофонта Уткина, 5'),(9,'Музей ретротехники','Exhibition','ул. Чернышевского, 106Д'),(10,'Центр культуры и современного искусства им. Ю.А. Гагарина','Exhibition','ул. Можайского, 25');
...
-- Dump completed on 2022-05-12 12:55:48
