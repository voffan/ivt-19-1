    ...
    public partial class Form1 : Form {
        public Form1() {
            ...
            using (Context c = new Context()) {
                dataGridView1.DataSource = c.Computers.Include(x => x.Department).Include(y => y.Motherboard).Include(z => z.Employee).ToList();
            }
        ...
        private void button1_Click(object sender, EventArgs e) {
            switch (listBox1.SelectedIndex) {
                case 0: //Computers
                    ...
                    {
                        dataGridView1.DataSource = c0.Computers.Include("Department").Include("Motherboard").ToList();
                ...
                case 2: //Employees
                    ...
                    dataGridView1.Columns[2].Visible = false; // Строка пароля
                    break;
                case 3: //HDDs
