...
namespace Comp_park_app
{
    public partial class Form_addComputer : Form
    {
        ...
        {
            hdd.Add((HDD)comboBox_HDD.SelectedItem);
            listBox1.DataSource = null;
            listBox1.Items.Clear();
            listBox1.DataSource = hdd;
        ...
        {
            hdd.RemoveRange(listBox1.SelectedIndex, 1);
            listBox1.DataSource = null;
            listBox1.Items.Clear();
            listBox1.DataSource = hdd;
        ...
        private void Form_addComputer_Load(object sender, EventArgs e)
        {
            ...
            comboBox1.Items.Add(comboBox_HDD.SelectedValue.ToString());
            listBox1.DataSource = hdd;
            listBox2.DataSource = ram;
            listBox3.DataSource = proc;
        }
        ...
        private void button_addComputer_Click(object sender, EventArgs e)
        {
                ...
                comboBox_Motherboard.SelectedIndex >= 0)
            {
                ...
                var hdds = listBox1.ValueMember.Cast<HDD>().ToList();
                var rams = listBox2.ValueMember.Cast<RAM>().ToList();
                var processors = listBox3.ValueMember.Cast<Processor>().ToList();
