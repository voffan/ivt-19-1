...
namespace Autoreport.Migrations
{
    ...
    [Migration("20220211080304_У работников добавлены статусы, должности, а также логин и пароль")]
    partial class Уработниковдобавленыстатусыдолжностиатакжелогинипароль
    {
